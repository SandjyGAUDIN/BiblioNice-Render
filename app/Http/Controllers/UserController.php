...
class UserController extends Controller
{
    ...
    public function CreateUser(Request $request){
        ...
        $utilisateurs = User::create([
            ...
            'reception_newsletter' =>$validated['news'], // Utilisation de la variable $news
        ]);
   ...
   public function ListeUsers()
   {
       ...
       return view('listeUsers', compact('users')); // Envoie les données à la vue
   }
   ...
   public function supprimer($id_utilisateur) {
    ...
    if (session('user')['role'] != 'gestionnaire') {
        return redirect()->route('users.list')->withErrors('Vous n\'êtes pas autorisé à supprimer un utilisateur.');
    }
